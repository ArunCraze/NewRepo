...
namespace BankingSystem.RepositoryImpl
{
    ...
    {
        public void CreateAccount(Customers customer, long accNo, string accType, decimal balance)
        {
       ...
       /* public List<Transaction> GetTransactions(long accountNumber, DateTime fromDate, DateTime toDate, Transactions txn)
        {
